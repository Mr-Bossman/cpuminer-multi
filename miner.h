...
#ifdef USE_ASM
#if (defined(__APCS_32__) && defined(__ARM_NEON__)) || defined(__i386__) || defined(__x86_64__)
...
int scanhash_verus(int thr_id, struct work* work, uint32_t max_nonce, uint64_t *hashes_done);
